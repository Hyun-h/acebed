<?php
    ...
    //암호화
    $hash_pw = password_hash($_POST['pw'], PASSWORD_DEFAULT);

    //DB 저장
    include "connect.php";
    $sql_Typing = "INSERT INTO membership_join(names,phone_num,email,pw)
    VALUES('{$name}','{$tel}','{$email}','{$hash_pw}')";
...
<body>
    ...
    <main>
        <h2>가입완료</h2>
        <section>
            <article id="join_finish_wrap">
                <div id="join_finish">
                    <div class="finish_img">
                        <img src="img/join-complete-icon.jpg" alt="join finish icon">
                    </div>
                    <div class="finish_text">
                        ...
                        <p>
                            에이스 침대의 다양한 소식을 만나보세요!
                        </p>
                    </div>
                    <div class="finish_btn">
                        <a href="login.html">로그인</a>
                    </div>
                    <div class="finish_main_btn">
