    ...
    <main>
        ...
        <article>
            <div class="event_serch">
                ...
                <div class="serch_input">
                    ...
                    <span class="serch_input_btn"></span>
                </div>
            </div>
        </article>
        <article id="event_announce">
            <p>총 <strong>0 건</strong>
                <a href="notice_text.html">
                    게시물 작성
                </a>
            </p>
            <ul>
                <?php
                    while($row = mysqli_fetch_array($result)){
                        ...
                        <li>
                            ...
                            <a href=\"notice_final.php?num={$row['num']}\">
                                <p>{$row['title']}</p>
                            </a>
                            <span class=\"date\">{$row['dates']}</span>
                        </li> ";
                    }
                ?>
            </ul>
        ...
        <div class="page_move">
            <ul>
                ...
                <li><img src="img/paging-last-next-on.png"></li>
            </ul>
        </div>
    </main>
